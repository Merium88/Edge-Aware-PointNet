...
def showpoints(xyz,corners,c_gt=None, c_pred = None ,waittime=0,showrot=False,magnifyBlue=0,freezerot=False,background=(0,0,0),normalizecolor=True,ballradius=1,pcd=True):
    ...
    while pcd:
        ...
        #cv2.drawContours(show, [corners[:4]],-1,(0,255,0),-3)
        #for i,j in zip(range(4),range(4,8)):
        #   cv2.line(show, tuple(corners[i]), tuple(corners[j]),(255),3)
        #cv2.drawContours(show, [corners[4:]],-1,(0,0,255),3)
